...
import { 
  Scale, Shield, Users, ArrowRight, CheckCircle, X, Menu, Briefcase, 
  FileText, ChevronRight, Sparkles, AlertTriangle, FileCheck, Loader2, 
  Globe, CreditCard, Coins, Calculator, Info, MapPin, Building, Landmark, 
  Car, ShoppingCart, Zap, Plane, Activity, Flag, ChevronDown, Mail, Phone, Map,
  Plus, Image as ImageIcon, Paperclip, Trash2, Copy, Check
} from 'lucide-react';
import { GoogleGenAI } from "@google/genai";

// --- ASSETS & CONFIG ---
const MAP_BG_URL = "https://maps.googleapis.com/maps/api/staticmap?center=Belgrade,Serbia&zoom=14&size=1200x600&style=feature:all|element:all|saturation:-100|visibility:simplified&style=feature:landscape.man_made|element:geometry|color:0x000000&style=feature:road.local|element:geometry.fill|color:0x404040&key=YOUR_API_KEY_HERE"; 

// --- GEMINI API UTILS ---
const callGemini = async (prompt: string, systemInstruction: string, attachment: { data: string, mimeType: string } | null) => {
  try {
    ...
    return JSON.stringify({
        plain_english: "Service currently unavailable due to connectivity or API limits.",
        risk_level: "Unknown",
...
const CRIMINAL_DATA_EN: CriminalOption[] = [
  { id: 'opt1', label: "Fine or imprisonment up to 3 years", fees: { podnesak: 30000, rociste: 35000, zalba: 60000 } },
  { id: 'opt2', label: "Imprisonment over 3 to 5 years", fees: { podnesak: 37500, rociste: 42500, zalba: 75000 } },
  { id: 'opt3', label: "Imprisonment over 5 to 10 years", fees: { podnesak: 50000, rociste: 55000, zalba: 100000 } },
  { id: 'opt4', label: "Imprisonment over 10 to 15 years", fees: { podnesak: 75000, rociste: 80000, zalba: 150000 } },
  { id: 'opt5', label: "Imprisonment over 15 years", fees: { podnesak: 100000, rociste: 105000, zalba: 200000 } },
  { id: 'opt6', label: "30-40 years / Life Imprisonment", fees: { podnesak: 125000, rociste: 130000, zalba: 250000 } },
];

const CRIMINAL_DATA_SR: CriminalOption[] = [
  { id: 'opt1', label: "Novčana kazna ili zatvor do 3 godine", fees: { podnesak: 30000, rociste: 35000, zalba: 60000 } },
  { id: 'opt2', label: "Zatvor preko 3 do 5 godina", fees: { podnesak: 37500, rociste: 42500, zalba: 75000 } },
  { id: 'opt3', label: "Zatvor preko 5 do 10 godina", fees: { podnesak: 50000, rociste: 55000, zalba: 100000 } },
  { id: 'opt4', label: "Zatvor preko 10 do 15 godina", fees: { podnesak: 75000, rociste: 80000, zalba: 150000 } },
  { id: 'opt5', label: "Zatvor preko 15 godina", fees: { podnesak: 100000, rociste: 105000, zalba: 200000 } },
  { id: 'opt6', label: "30-40 godina / Doživotni zatvor", fees: { podnesak: 125000, rociste: 130000, zalba: 250000 } },
];

const NON_ASSESSABLE_DATA_EN: NonAssessableOption[] = [
  { id: 'vanparnicni_licna', label: "Non-contentious - Personal Status", base: 27500 },
  { id: 'vanparnicni_porodicni', label: "Non-contentious - Family Relations", base: 27500 },
  { id: 'vanparnicni_imovinski', label: "Non-contentious - Property Relations", base: 50000 },
  { id: 'katastar', label: "Real Estate Cadastre Registration", base: 27500 },
  { id: 'stecaj', label: "Bankruptcy and Liquidation", base: 42500 },
  { id: 'upravni_poreski', label: "Administrative - Tax, Customs, Interior", base: 50000 },
];

const NON_ASSESSABLE_DATA_SR: NonAssessableOption[] = [
  { id: 'vanparnicni_licna', label: "Vanparnični - Lična stanja", base: 27500 },
  { id: 'vanparnicni_porodicni', label: "Vanparnični - Porodični odnosi", base: 27500 },
  { id: 'vanparnicni_imovinski', label: "Vanparnični - Imovinski odnosi", base: 50000 },
  { id: 'katastar', label: "Upis u Katastar nepokretnosti", base: 27500 },
  { id: 'stecaj', label: "Stečajni i likvidacioni postupak", base: 42500 },
  { id: 'upravni_poreski', label: "Upravni - Poreski, Carinski, MUP", base: 50000 },
];
...
const CLIENTS_LIST: ClientData[] = [
  ...
  { name: "Ministarstvo Finansija", categoryKey: "government", logo: "ministarstvo.png" },
  { name: "Skijališta Srbije", categoryKey: "publicEnt", logo: "skijalista.png" },
  { name: "Komercijalna Banka", categoryKey: "banking", logo: "komercijalna.png" },
  { name: "Teniski Savez Srbije", categoryKey: "sports", logo: "teniski.png" },
  { name: "Whirlpool", categoryKey: "manufacturing", logo: "whirlpool.png" },
  { name: "Hypo Alpe Adria", categoryKey: "banking", logo: "hypo.png" },
  { name: "Air Serbia / Aerokarte", categoryKey: "transport", logo: "airserbia.png" },
  { name: "Elektromreže Srbije", categoryKey: "energy", logo: "emc.png" },
  { name: "Olimpijski Komitet", categoryKey: "arbitration", logo: "olimpijski.png" },
  { name: "Agencija za Privatizaciju", categoryKey: "government", logo: "agencija.png" },
];
...
const translations = {
  en: {
    nav: { about: "About Us", legalAid: "Schedule Consultation", clients: "Our Clients", calculator: "Tariff Calculator", analyst: "AI Legal Analyst", contact: "Contact" },
    hero: {
    ...
    services: {
      ...
      cards: [
        { title: "Corporate Law", desc: "Company formation, status changes, commercial contracts, and business compliance with regulations." },
        { title: "Legal Consulting", desc: "Strategic management consulting, legal risk analysis, and support in key business decision-making." },
        { title: "Dispute Resolution", desc: "Representation in litigation, non-contentious, and enforcement proceedings before all courts of general and special jurisdiction in Serbia." }
      ]
    },
    fee: {
      tag: "// TARIFF & FEES",
      ...
      consultations: {
        ...
        creditDesc: "100% of consultation fee is credited towards future services."
      },
      calculator: {
    ...
    clients: {
      title: "Naši Klijenti",
      subtitle: "Poverenje nam poklanjaju vodeće kompanije, državne institucije i međunarodne organizacije.",
      buttonLabel: "Reference"
    },
    contact: {
      title: "Zakažite Konsultacije",
      subtitle: "Kontaktirajte nas telefonom, e-mailom ili putem forme ispod. Garantujemo potpunu diskreciju.",
      form: {
        name: "IME I PREZIME",
        phone: "BROJ TELEFONA",
        email: "E-MAIL ADRESA",
  ...
  sr: {
    nav: { about: "O nama", legalAid: "Zakažite Konsultacije", clients: "Naši Klijenti", calculator: "Kalkulator Advokatske Tarife", analyst: "AI Analitičar", contact: "Kontakt" },
    hero: {
      badge: "Ristić Advokatska Kancelarija 2.0 • Ekspertiza u složenim sporovima",
    ...
    services: {
      ...
      cards: [
        { title: "Korporativno Pravo", desc: "Osnivanje privrednih društava, statusne promene, ugovori u privredi i usklađivanje poslovanja sa zakonskom regulativom." },
        { title: "Pravni Konsalting", desc: "Strateško savetovanje menadžmenta, pravna analiza rizika i podrška u donošenju ključnih poslovnih odluka." },
        { title: "Rešavanje Sporova", desc: "Zastupanje u parničnim, vanparničnim i izvršnim postupcima pred svim sudovima opšte i posebne nadležnosti u Srbiji." }
      ]
    },
    fee: {
...
export default function App() {
  ...
  useEffect(() => {
    if (lang === 'sr') {
      document.title = "Advokatska Kancelarija Ristić | Privredno Pravo i Rešavanje Sporova";
      document.documentElement.lang = "sr";
      document.querySelector('meta[name="description"]')?.setAttribute("content", "Vrhunske pravne usluge u Beogradu od 1992. Specijalizovani za privredno pravo, međunarodnu arbitražu i složene sudske sporove.");
      document.querySelector('meta[property="og:title"]')?.setAttribute("content", "Advokatska Kancelarija Ristić | Privredno Pravo i Rešavanje Sporova");
      document.querySelector('meta[property="og:description"]')?.setAttribute("content", "Vrhunske pravne usluge u Beogradu od 1992. Specijalizovani za privredno pravo, međunarodnu arbitražu i složene sudske sporove.");
    } else {
      document.title = "Ristic Law Office | Corporate Law & Dispute Resolution";
      document.documentElement.lang = "en";
      document.querySelector('meta[name="description"]')?.setAttribute("content", "Premium legal services in Belgrade, Serbia since 1992. Specializing in corporate law, international arbitration, and complex litigation.");
      document.querySelector('meta[property="og:title"]')?.setAttribute("content", "Ristic Law Office | Corporate Law & Dispute Resolution");
      document.querySelector('meta[property="og:description"]')?.setAttribute("content", "Premium legal services in Belgrade, Serbia since 1992. Specializing in corporate law, international arbitration, and complex litigation.");
    }
  }, [lang]);
  
  const [activeTab, setActiveTab] = useState<'criminal' | 'assessable' | 'nonAssessable'>('criminal');
  ...
  const nonAssessableData = lang === 'en' ? NON_ASSESSABLE_DATA_EN : NON_ASSESSABLE_DATA_SR;
  
  // Calculator State
  const [assessableValue, setAssessableValue] = useState<number>(0);
  const [selectedCriminal, setSelectedCriminal] = useState<string>('');
  const [selectedNonAssessable, setSelectedNonAssessable] = useState<string>('');
  ...
  const navBackground = useTransform(scrollY, [0, 50], ["rgba(11, 17, 32, 0)", "rgba(11, 17, 32, 0.8)"]);
  ...
  const handleCalculate = () => {
    ...
    if (activeTab === 'criminal') {
      ...
      if (opt) result = { podnesak: opt.base, rociste: opt.base + 4500, zalba: opt.base * 2 };
    } else {
  ...
  useEffect(() => { handleCalculate(); }, [activeTab, selectedCriminal, selectedNonAssessable, assessableValue, lang]);
  ...
  const handleDecode = async () => {
    ...
    try {
        ...
        setDecoderResult({ plain_english: resultStr, risk_level: "Info", key_risk: "Analysis", engineer_note: "Raw output." });
    }
    setIsDecoding(false);
  };
  ...
  const handleContactSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const subject = encodeURIComponent(`Novi Upit sa Sajta: ${contactForm.name}`);
  ...
  const scrollToSection = (e: React.MouseEvent<HTMLAnchorElement | HTMLButtonElement>, id: string, block: 'start' | 'center' | 'end' | 'nearest' = 'start') => {
    e.preventDefault();
  ...
  const contactDetails = [
    { id: 'addr', label: t.contactModal.address, value: lang === 'en' ? "Desanke Maksimović 17, Belgrade" : "Desanke Maksimović 17, Beograd", icon: MapPin },
    { id: 'phone', label: t.contactModal.phone, value: "011/3239-088", icon: Phone },
    { id: 'mob', label: t.contactModal.mobile, value: "060/605-8144", icon: Phone },
    { id: 'mail', label: t.contactModal.email, value: "office@akristic.rs", icon: Mail },
  ];
    ...
    <div className="min-h-screen bg-[#0B1120] text-slate-200 font-sans selection:bg-blue-500/30 selection:text-blue-200">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
             <div className="bg-white p-1.5 rounded-lg flex items-center justify-center">
                 <img src="logo.png" alt="Ristic Law Office" className="h-8 w-auto object-contain" />
             </div>
             ...
             <span className="font-bold text-lg tracking-tight text-white">Ristic Law</span>
          </div>
          
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
            <a href="#about" onClick={(e) => scrollToSection(e, 'about')} className="hover:text-white transition-colors">{t.nav.about}</a>
            <a href="#contact" onClick={(e) => scrollToSection(e, 'contact')} className="hover:text-white transition-colors">{t.nav.legalAid}</a>
            <a href="#clients" onClick={(e) => scrollToSection(e, 'clients')} className="hover:text-white transition-colors">{t.nav.clients}</a>
            <a href="#calculator" onClick={(e) => scrollToSection(e, 'calculator', 'center')} className="hover:text-white transition-colors">{t.nav.calculator}</a>
            <a href="#ai" onClick={(e) => scrollToSection(e, 'ai')} className="hover:text-white transition-colors">{t.nav.analyst}</a>
          </div>
        ...
        {isMenuOpen && (
          ...
          >
             <div className="flex flex-col p-6 space-y-4">
                <a href="#about" onClick={(e) => scrollToSection(e, 'about')} className="text-slate-300 hover:text-white py-2">{t.nav.about}</a>
                <a href="#contact" onClick={(e) => scrollToSection(e, 'contact')} className="text-slate-300 hover:text-white py-2">{t.nav.legalAid}</a>
                <a href="#clients" onClick={(e) => scrollToSection(e, 'clients')} className="text-slate-300 hover:text-white py-2">{t.nav.clients}</a>
                <a href="#calculator" onClick={(e) => scrollToSection(e, 'calculator')} className="text-slate-300 hover:text-white py-2">{t.nav.calculator}</a>
                <a href="#ai" onClick={(e) => scrollToSection(e, 'ai')} className="text-slate-300 hover:text-white py-2">{t.nav.analyst}</a>
                <button onClick={() => { setIsContactModalOpen(true); setIsMenuOpen(false); }} className="text-left text-slate-300 hover:text-white py-2">{t.nav.contact}</button>
             </div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <section id="about" className="py-24 px-6 bg-[#0B1120] scroll-mt-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-blue-500 font-medium text-lg mb-8">{t.about.subtitle}</p>
          ...
          <div className="bg-[#111827] border border-white/5 rounded-2xl p-8 relative overflow-hidden group hover:border-blue-500/20 transition-colors duration-500">
             ...
             <h3 className="text-white font-bold text-xl mb-8 relative z-10">{t.about.keyFacts.title}</h3>
      ...
      <section id="services" className="py-24 px-6 scroll-mt-24">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            <span className="text-blue-500 font-mono text-xs uppercase tracking-wider">{t.services.tag}</span>
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-6">{t.services.title}</h2>
            <p className="text-slate-400 max-w-2xl text-lg">{t.services.desc}</p>
          </div>
            ...
            {t.services.cards.map((card, i) => (
              <GlowCard key={i} className="p-8">
                <div className="w-12 h-12 bg-slate-800/50 rounded-lg flex items-center justify-center text-slate-300 mb-8 group-hover:scale-105 transition-transform">
                  {i === 0 ? <Shield className="w-6 h-6" /> : i === 1 ? <Briefcase className="w-6 h-6" /> : <Scale className="w-6 h-6" />}
                </div>
      ...
      <section id="fee" className="py-24 px-6 bg-[#0B1120] scroll-mt-24">
         <div className="max-w-7xl mx-auto">
            <div className="mb-12">
                <span className="text-blue-500 font-mono text-xs uppercase tracking-wider">{t.fee.tag}</span>
                <h2 className="text-4xl md:text-5xl font-bold text-white mt-4">{t.fee.title}</h2>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div className="lg:col-span-1 bg-[#111827] border border-white/5 rounded-2xl p-6 flex flex-col justify-between relative overflow-hidden group hover:border-blue-500/20 transition-colors duration-500">
                   ...
                   <div className="relative z-10">
                       ...
                       <h3 className="text-xl font-bold text-white mb-2">{t.fee.consultations.title}</h3>
                       <div className="flex items-baseline gap-1 mb-6">
                           <span className="text-4xl font-bold text-white">{t.fee.consultations.price}</span>
                           <span className="text-slate-500">{t.fee.consultations.unit}</span>
                       </div>
                   ...
                   <div className="bg-[#1a2236] border border-blue-500/10 rounded-xl p-4 relative z-10">
                       <div className="flex items-center gap-2 mb-2">
                           ...
                           <span className="text-white font-medium text-sm">{t.fee.consultations.creditTitle}</span>
                       </div>
                       <p className="text-slate-400 text-sm">{t.fee.consultations.creditDesc}</p>
                   </div>
                </div>

                {/* Calculator Card */}
                <div id="calculator" className="lg:col-span-2 bg-[#111827] border border-white/5 rounded-2xl p-8 scroll-mt-32">
                   ...
                   <div className="space-y-6">
                       <div>
                           <label className="block text-slate-500 text-xs font-bold uppercase tracking-wider mb-2">{t.fee.calculator.selectType}</label>
                           <div className="relative">
                               ...
                               >
                                   <option value="criminal">{t.fee.calculator.criminal}</option>
                                   <option value="assessable">{t.fee.calculator.assessable}</option>
                                   <option value="nonAssessable">{t.fee.calculator.nonAssessable}</option>
                               </select>
                       ...
                       <div>
                           <label className="block text-slate-500 text-xs font-bold uppercase tracking-wider mb-2">
                               {activeTab === 'assessable' ? t.fee.calculator.valueLabel : t.fee.calculator.details}
                           </label>
                           <div className="relative">
                               {activeTab === 'criminal' ? (
                                   <select 
                                     ...
                                     className="w-full bg-[#0B1120] border border-white/10 rounded-lg py-3 px-4 text-white appearance-none focus:outline-none focus:border-blue-500 transition-colors cursor-pointer"
                                   >
                                       <option value="" disabled>{t.fee.calculator.placeholder}</option>
                                       {criminalData.map(opt => <option key={opt.id} value={opt.id}>{opt.label}</option>)}
                                   </select>
                               ) : activeTab === 'nonAssessable' ? (
                                   <select 
                                     value={selectedNonAssessable}
                                     onChange={(e) => setSelectedNonAssessable(e.target.value)}
                                     className="w-full bg-[#0B1120] border border-white/10 rounded-lg py-3 px-4 text-white appearance-none focus:outline-none focus:border-blue-500 transition-colors cursor-pointer"
                                   >
                                       <option value="" disabled>{t.fee.calculator.placeholder}</option>
                                       {nonAssessableData.map(opt => <option key={opt.id} value={opt.id}>{opt.label}</option>)}
                                   </select>
                               ) : (
                                   <div className="relative">
                                      <input 
                                      ...
                                      />
                                      <span className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 text-sm">RSD</span>
                                   </div>
                               )}
                               {activeTab !== 'assessable' && <ChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 pointer-events-none" />}
                           </div>
                       </div>
                   </div>
                   ...
                   <div className="mt-8 bg-white text-slate-900 rounded-lg p-6">
                       {calcResult ? (
                           <div className="grid grid-cols-3 gap-4 text-center">
                               <div>
                                   <div className="text-[10px] uppercase font-bold text-slate-500 mb-1">{t.fee.calculator.results.podnesak}</div>
                                   <div className="font-mono font-bold text-lg">{calcResult.podnesak.toLocaleString()}</div>
                               </div>
                               <div className="border-l border-slate-200">
                                   <div className="text-[10px] uppercase font-bold text-slate-500 mb-1">{t.fee.calculator.results.rociste}</div>
                                   <div className="font-mono font-bold text-lg">{calcResult.rociste.toLocaleString()}</div>
                               </div>
                               <div className="border-l border-slate-200">
                                   <div className="text-[10px] uppercase font-bold text-slate-500 mb-1">{t.fee.calculator.results.zalba}</div>
                                   <div className="font-mono font-bold text-lg">{calcResult.zalba.toLocaleString()}</div>
                               </div>
                           </div>
                       ) : (
                 ...
                 {attachment && (
                    <div className="mx-2 mt-2 inline-flex items-center gap-3 bg-[#3c4043] rounded-xl px-4 py-2 self-start animate-in fade-in zoom-in duration-200">
                        <div className="bg-red-500/20 p-2 rounded-lg">
                           {attachment.mimeType.startsWith('image/') ? <ImageIcon className="w-4 h-4 text-red-400" /> : <FileText className="w-4 h-4 text-red-400" />}
                        </div>
                        ...
                        <button onClick={removeAttachment} className="ml-2 hover:bg-white/10 p-1 rounded-full transition-colors">
                 ...
                 <div className="flex justify-between items-center px-2 pb-1">
                     ...
                     <button 
                        ...
                        className={`p-3 rounded-full transition-all flex items-center gap-2 ${
                            (decoderInput || attachment) ? 'bg-white text-black hover:bg-slate-200' : 'bg-[#3c4043] text-slate-500 cursor-not-allowed'
                        }`}
                     >
                        {isDecoding ? <Loader2 className="w-5 h-5 animate-spin" /> : <ArrowRight className="w-5 h-5" />}
                        {isDecoding && <span className="text-xs font-bold pr-2">{t.ai.analyzing}</span>}
                     </button>
                 </div>
            </div>
                    ...
                    >
                         <div className="flex gap-4">
                             ...
                             <div className="flex-1 space-y-6">
                                 <div>
                                     <h4 className="text-slate-500 text-xs font-bold uppercase tracking-wider mb-2">{t.ai.results.explanation}</h4>
                                     <p className="text-slate-200 leading-relaxed text-lg">{decoderResult.plain_english}</p>
                                 </div>
                                 
                                 <div className="grid md:grid-cols-2 gap-6 pt-6 border-t border-white/5">
                                     <div>
                                         <h4 className="text-slate-500 text-xs font-bold uppercase tracking-wider mb-2">{t.ai.results.risk}</h4>
                                         <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold uppercase ${
                                            decoderResult.risk_level === 'High' ? 'bg-red-500/20 text-red-400' : 
                                            decoderResult.risk_level === 'Medium' ? 'bg-amber-500/20 text-amber-400' :
                                     ...
                                     <div>
                                         <h4 className="text-slate-500 text-xs font-bold uppercase tracking-wider mb-2">{t.ai.results.keyConcern}</h4>
                                         <p className="text-slate-300 text-sm">{decoderResult.key_risk}</p>
                                     </div>
                                 </div>
                  ...
                  {CLIENTS_LIST.map((client, i) => (
                      <GlowCard key={i} className="p-8 min-h-[200px]">
                          <div className="flex flex-col items-center justify-center gap-6 text-center h-full w-full">
                            ...
                            <div>
                                <h3 className="font-bold text-white text-lg mb-1">{client.name}</h3>
                                <p className="text-[10px] font-mono text-slate-500 uppercase tracking-wider">
                                    {t.categories[client.categoryKey as keyof typeof t.categories]}
                                </p>
                            </div>
                          </div>
                      </GlowCard>
      ...
      {/* Contact Form & Footer */}
      <section id="contact" className="bg-[#000000] text-white pt-24 pb-12 relative scroll-mt-24">
          
          <div className="max-w-7xl mx-auto px-6 relative z-10">
              <div className="grid md:grid-cols-2 gap-16 mb-24">
                  <div>
                      <h2 className="text-5xl font-bold mb-6">{t.contact.title}</h2>
                      <p className="text-slate-400 text-lg mb-8 leading-relaxed max-w-md">{t.contact.subtitle}</p>
                      <div className="flex gap-6 text-[10px] font-mono font-bold text-emerald-500 uppercase tracking-widest">
                          <div className="flex items-center gap-2"><CheckCircle className="w-3 h-3" /> Encrypted</div>
                          <div className="flex items-center gap-2"><CheckCircle className="w-3 h-3" /> Attorney Privilege</div>
                      </div>
                  </div>
                  
                  <form onSubmit={handleContactSubmit} className="bg-[#111827] border border-white/10 rounded-2xl p-8 space-y-6">
                      <div className="grid md:grid-cols-2 gap-6">
                          <div>
                              <label className="text-[10px] font-bold text-slate-500 uppercase mb-2 block">{t.contact.form.name}</label>
                              <input 
                                type="text" 
                                name="name"
                          ...
                          <div>
                              <label className="text-[10px] font-bold text-slate-500 uppercase mb-2 block">{t.contact.form.phone}</label>
                              <input 
                                type="text" 
                                name="phone"
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                          <div>
                              <label className="text-[10px] font-bold text-slate-500 uppercase mb-2 block">{t.contact.form.email}</label>
                              <input 
                                type="email" 
                                name="email"
                          ...
                          <div>
                              <label className="text-[10px] font-bold text-slate-500 uppercase mb-2 block">{t.contact.form.address}</label>
                              <input 
                                type="text" 
                                name="address"
                      ...
                      <div>
                          <label className="text-[10px] font-bold text-slate-500 uppercase mb-2 block">{t.contact.form.summary}</label>
                          <textarea 
                            name="summary"
                      ...
                      <button type="submit" className="w-full bg-white text-black font-bold py-4 rounded-lg hover:bg-slate-200 transition-colors flex justify-center items-center gap-2">
                          <Sparkles className="w-4 h-4" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-t border-white/10 pt-12 pb-8">
                  <div className="col-span-1">
                      <div className="flex items-center gap-2 mb-6">
                         <div className="w-8 h-8 flex items-center justify-center bg-white rounded-lg">
                             <img src="logo.png" alt="Ristic Law" className="h-6 w-auto" />
                         </div>
                         <span className="font-bold text-white">Ristic Law</span>
                      </div>
                      <p className="text-slate-500 text-sm">Legal security and integrity since 1992.</p>
                  </div>
                  
                  <div>
                      <h4 className="text-white font-bold mb-6">{t.contact.footer.services}</h4>
                  ...
                  <div>
                      <h4 className="text-white font-bold mb-6">{t.contact.footer.office}</h4>
                      <ul className="space-y-4 text-sm text-slate-500">
                          <li>
                          ...
                          <li>
                              <a href="#calculator" onClick={(e) => scrollToSection(e, 'calculator', 'center')} className="hover:text-white transition-colors">
                                  {t.nav.calculator}
                              </a>
                          </li>
                          <li>
                              <a href="#ai" onClick={(e) => scrollToSection(e, 'ai')} className="hover:text-white transition-colors">
                                  {t.nav.analyst}
                              </a>
                          </li>
                      </ul>
                  ...
                  <div>
                      <h4 className="text-white font-bold mb-6">{t.contact.footer.contact}</h4>
                      <ul className="space-y-4 text-sm text-slate-500">
                          <li>Desanke Maksimović 17</li>
                          <li>11000 {lang === 'en' ? 'Belgrade, Serbia' : 'Beograd, Srbija'}</li>
                          <li className="pt-4">Tel: 011/3239-088</li>
                          <li>Mob: 060/605-8144</li>
                          <li><a href="mailto:office@akristic.rs" className="text-blue-500 hover:underline">office@akristic.rs</a></li>
                      </ul>
                  </div>
              </div>
          </div>
          ...
          >
            ...
            >
               <div className="p-6 border-b border-white/10 flex justify-between items-center">
                   <h3 className="text-xl font-bold text-white">Client Reference List</h3>
                   <button onClick={() => setShowAllClients(false)} className="text-slate-400 hover:text-white"><X /></button>
               </div>
               <div className="p-8 overflow-y-auto custom-scrollbar grid grid-cols-2 md:grid-cols-3 gap-y-4 gap-x-8">
                  {FULL_CLIENTS_LIST.map((c, i) => (
                      <div key={i} className="flex items-center gap-3 text-slate-400 hover:text-white transition-colors">
          ...
          >
            ...
            >
               <div className="p-6 border-b border-white/10 flex justify-between items-center bg-[#0B1120]">
                   ...
                   <button onClick={() => setIsContactModalOpen(false)} className="text-slate-400 hover:text-white transition-colors p-1 hover:bg-white/5 rounded-lg"><X className="w-5 h-5"/></button>
               </div>
               
               <div className="p-6 space-y-4">
                  {contactDetails.map((item) => (
                    <div key={item.id} className="group p-4 rounded-xl bg-[#0B1120] border border-white/5 hover:border-blue-500/30 transition-all">
